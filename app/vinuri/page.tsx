    ...
    <>
      {!searchParams.house ? (
        <div className="my-8 font-semibold">
          <h1 className="text-3xl text-center pb-1">
            Descopera sortimentele noastre de vin
          </h1>
          <p className="text-lg text-center max-w-3xl mx-auto">
            Fiecare sortiment de vin este rezultatul unei combinaţii inedite
            între expresivitatea soiului de strugure, solul specific zonei,
            condiţiile climatice din anul recoltei şi talentul vinificatorului
          </p>
        </div>
      ) : (
        <div className="my-8 font-semibold">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
        {wines.map((wine) => {
          return (
            <div
              key={wine._id}
              className="bg-muted w-full shadow-md shadow-primary/5"
            >
